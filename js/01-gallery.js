...
// const currentActiveImage = document.querySelector('gallery__link:hover');
// if(currentActiveImage){
//   currentActiveImage.classList.remove(':hover');
// }

// const swatchEL = evt.target;
// const parentPictureImage = swatchEL.closest('gallery__link');
// parentPictureImage.classList.add(':hover');
